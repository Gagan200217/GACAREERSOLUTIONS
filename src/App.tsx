        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-800">GACareerSolutions</h1>
                <p className="text-xs text-gray-500">Connecting Talent with Opportunities</p>
              </div>
            </div>
